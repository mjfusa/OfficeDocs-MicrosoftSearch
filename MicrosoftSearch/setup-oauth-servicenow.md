...
1. **Enter OAuth Credentials**  
   ...
   - **Client Secret** – Keep this confidential and store it securely.
    ...
    ![Screenshot of OAuth credentials fields.](/MicrosoftSearch/media/setup-oauth-snow-credentials.png)
...
3. **Log in to ServiceNow**  
   ...
   > Use the **same account** that was used to register the OAuth application.
      ...
      ![Screenshot of pop-up window.](/MicrosoftSearch/media/setup-oauth-login-instance.png)
...
4. **Grant Permissions**  
   ...
   Click **‘Allow’** to proceed.
      ...
      ![Screenshot of the grant access screen](/MicrosoftSearch/media/setup-oauth-allow-access.png)
...
5. **Verify Authentication**  
   ...
   - A **green checkmark** next to the authentication fields confirms successful authentication.  
      ...
      ![Screenshot of the oauth success screen](/MicrosoftSearch/media/setup-oauth-successful.png)