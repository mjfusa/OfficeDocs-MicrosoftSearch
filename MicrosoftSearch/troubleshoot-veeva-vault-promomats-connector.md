...
![Click the thumbs-up/thumbs-down icons at the bottom of each response.](media/veeva-vault-promats-troubleshoot-1.png)
...
![Submit feedback to Microsoft window.](media/veeva-vault-promats-troubleshoot-2.png) 
