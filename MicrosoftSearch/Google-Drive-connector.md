...
![gdrive-check-user-role](media/google-drive-connector/gdrive-check-user-role.png)
...
![gdrive-create-new-project.png](media/google-drive-connector/gdrive-create-new-project.png)

c.	Note the project ID (which is directly below the project name) as you will need it when enabling APIs in step 3.
![gdrive-create-new-project.png](media/google-drive-connector/gdrive-check-project-id.png)
...
![gdrive-create-new-project.png](media/google-drive-connector/gdrive-enable-api.png)
...
a.	Go to the [Service Accounts](https://console.cloud.google.com/projectselector2/iam-admin/serviceaccounts?inv=1&invt=Absc-w&supportedpurview=project) page in the GCP console and click the project you created.
![gdrive-create-service-account-1.png](media/google-drive-connector/gdrive-create-service-account-1.png)

b.	Click Create Service Account. 
![gdrive-create-service-account-2.png](media/google-drive-connector/gdrive-create-service-account-2.png)

c.	Enter the service account name, ID (which should be automatically populated from the name), and description (optional), then click Create and Continue.
![gdrive-create-service-account-3.png](media/google-drive-connector/gdrive-create-service-account-3.png)

d.	Skip Grant this service account access to project and Grant users access to this service account. Click Done.
![gdrive-create-service-account-4.png](media/google-drive-connector/gdrive-create-service-account-4.png)

e.	Back on the Service Accounts page for your project, you should now be able to see the service account that was just created. Click the 3 dots below Actions and click Manage Keys.
![gdrive-manage-kyes.png](media/google-drive-connector/gdrive-manage-kyes.png)

f.	Click Add Key > Create New Key. In the panel that appears, select the key type JSON then click Create.
![gdrive-create-new-key.png](media/google-drive-connector/gdrive-create-new-key.png)

g.	A private JSON key will be saved to your computer.
![gdrive-create-private-key.png](media/google-drive-connector/gdrive-create-private-key.png)
...
![gdrive-add-api-scope-1.png](media/google-drive-connector/gdrive-add-api-scope-1.png)

b.	Click “MANAGE DOMAIN WIDE DELEGATION” in section Domain wide delegation:
![gdrive-add-api-scope-2.png](media/google-drive-connector/gdrive-add-api-scope-2.png)

c.	Click Add new to add to add required scopes to the service account:
![gdrive-add-api-scope-3.png](media/google-drive-connector/gdrive-add-api-scope-3.png)
...
>
> Go to [Google Cloud console](https://console.cloud.google.com/iam-admin/serviceaccounts?inv=1&invt=AbtJpg&project=sample-project-454709), click service account in main menu, copy the  the “OAuth 2 Client ID” of the service account.
![gdrive-obatain-client-id.png](media/google-drive-connector/gdrive-obatain-client-id.png)
