...
![Screenshot that shows how to check gdrive user role](media/google-drive-connector/gdrive-check-user-role.png)
...
![Screenshot that shows how to create a new project in google drive](media/google-drive-connector/gdrive-create-new-project.png)

c. Note the project ID (which is directly below the project name) as you'll need it when enabling APIs in step 3.
![Screenshot that shows how to find project id](media/google-drive-connector/gdrive-check-project-id.png)
...
![Screenshot that shows how to create a project in google drive](media/google-drive-connector/gdrive-enable-api.png)
...
![Screenshot that shows how to create service account-step1](media/google-drive-connector/gdrive-create-service-account-1.png)

b.	Click Create Service Account. 
![Screenshot that shows how to create service account-step2](media/google-drive-connector/gdrive-create-service-account-2.png)

c.	Enter the service account name, ID, and description (optional), then click Create and Continue. 
![Screenshot that shows how to create service account-step3](media/google-drive-connector/gdrive-create-service-account-3.png)
...
![Screenshot that shows how to create service account-step4](media/google-drive-connector/gdrive-create-service-account-4.png)
...
![Screenshot that shows how to manage keys of service account](media/google-drive-connector/gdrive-manage-kyes.png)
...
![Screenshot that shows how to add api scope-step1](media/google-drive-connector/gdrive-add-api-scope-1.png)

b.	Click “MANAGE DOMAIN WIDE DELEGATION” in section Domain wide delegation:
![Screenshot that shows how to add api scope-step2](media/google-drive-connector/gdrive-add-api-scope-2.png)

c.	Click Add new to add required scopes to the service account:
![Screenshot that shows how to add api scope-step3](media/google-drive-connector/gdrive-add-api-scope-3.png)
